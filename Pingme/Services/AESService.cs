...
namespace Pingme.Services
{
    public class AESService 
    {
        ...
        //    }
        //}
        public (string EncryptedText, string IV, string Hash) EncryptMessageWithHash(string plainText, string base64Key)
        {
            byte[] key = Convert.FromBase64String(base64Key);
            using (var aes = Aes.Create())
            {
                ...
                using (var encryptor = aes.CreateEncryptor())
                {
                    ...
                    return (cipherBase64, ivBase64, hash);
                }
            }
        }
        ...
        //    }
        //}
        public (string PlainText, bool IsValid) DecryptMessageWithHashCheck(string cipherBase64, string base64Key, string ivBase64, string expectedHash)
        {
            try
            {
